...
def getAllColaboradores(conexion):
 
    conexion.execute('SELECT * FROM COLABORADOR_FEX')
    colaboradores = conexion.fetchall()
    
    return jsonify(colaboradores)


def getColaboradorFiltro(mysql,request,datoIngresado):
